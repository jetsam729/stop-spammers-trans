...
Plugin URI: 
Description: Stop WordPress Spam (beta fork for translate)
Version: B.1.0.1
License: https://www.gnu.org/licenses/gpl.html
*/

define('SFS_TXTDOMAIN',	'sfs-plugin');	// define for translate - if who changed/conflict
$sfs_load_lang = load_plugin_textdomain( SFS_TXTDOMAIN, false, dirname(plugin_basename(__FILE__)) . '/languages');

// networking requires a couple of globals
define( 'SS_VERSION',		'B.1.0.1' );
